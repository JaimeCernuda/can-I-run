...
const About: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
        <div className="container mx-auto px-4 py-8 max-w-5xl text-gray-200">
            <button
                onClick={onBack}
                className="mb-8 px-5 py-2.5 bg-gray-700/50 hover:bg-gray-600 rounded-lg text-sm font-medium transition-colors border border-gray-600/50"
            >
                ← Back to Calculator
            </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                {/* VRAM MATH SECTION */}
                <section className="bg-gray-900/50 p-8 rounded-2xl border border-gray-700/50 backdrop-blur-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="bg-gray-950/50 p-4 rounded-lg border border-gray-800 overflow-x-auto">
                        ...
                        <div>
                            ...
                            <div className="bg-gray-950/50 p-3 rounded-lg border border-gray-800 text-sm">
            ...
            <section className="mb-16">
                ...
                <div className="bg-gray-800/40 rounded-xl p-8 border border-gray-700 mb-8">
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-700">
                    <table className="w-full text-left bg-gray-900/50">
                        ...
                        <tbody className="divide-y divide-gray-800 text-gray-300">
                            ...
                            <tr className="hover:bg-gray-800/50 opacity-60">
            ...
            <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="https://huggingface.co/unsloth" target="_blank" rel="noopener noreferrer"
                        className="group p-5 bg-gray-800/40 hover:bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all">
                        ...
                        <p className="text-sm text-gray-400">Direct parameter counts and architecture configs from the Unsloth library.</p>
                    </a>

                    <a href="https://github.com/ggerganov/llama.cpp" target="_blank" rel="noopener noreferrer"
                        className="group p-5 bg-gray-800/40 hover:bg-gray-800 rounded-xl border border-gray-700 hover:border-orange-500/50 transition-all">
                        ...
                        <p className="text-sm text-gray-400">Perplexity (PPL) degradation stats and memory overhead logic.</p>
                    </a>

                    <a href="https://github.com/XiongjieDai/GPU-Benchmarks-on-LLM-Inference" target="_blank" rel="noopener noreferrer"
                        className="group p-5 bg-gray-800/40 hover:bg-gray-800 rounded-xl border border-gray-700 hover:border-purple-500/50 transition-all">
                        ...
                        <p className="text-sm text-gray-400">Real-world tokens/sec measurements across RTX 3090/4090 and H100 hardware.</p>
                    </a>
                </div>
            </section>
        </div>
