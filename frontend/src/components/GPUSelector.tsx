      ...
      {isCustom ? (
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-gray-100 focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
          />
          <button
            onClick={() => {
              setIsCustom(false);
        ...
        <div className="relative">
          <button
            ...
            className="w-full px-3 py-2 text-left border border-gray-600 rounded-lg bg-gray-800 text-gray-100 hover:border-gray-500 focus:ring-2 focus:ring-blue-500"
          >
            ...
            <div className="absolute z-50 w-full mt-1 bg-gray-800 border border-gray-600 rounded-lg shadow-xl max-h-96 overflow-hidden">
              ...
              <div className="p-2 border-b border-gray-700">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-600 rounded bg-gray-700 text-gray-100 placeholder-gray-400 focus:outline-none focus:border-blue-500"
                  autoFocus
                />
              </div>

              {/* Vendor Filters */}
              <div className="flex gap-1 p-2 border-b border-gray-700 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600">
                {["All", "NVIDIA", "AMD", "Apple", "Intel"].map((vendor) => (
                  <button
                    ...
                    className={`px-2 py-1 text-xs rounded-full whitespace-nowrap transition-colors ${featureFilter === vendor
                      ? "bg-blue-900/50 text-blue-300 font-medium border border-blue-700"
              ...
              {/* GPU list */}
              <div className="overflow-y-auto max-h-72 scrollbar-thin scrollbar-thumb-gray-600">
                {/* Custom VRAM option */}
                <button
                  onClick={handleCustomToggle}
                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-700 text-blue-400 font-medium border-b border-gray-700 transition-colors"
                >
                  Enter custom VRAM...
                </button>
                ...
                {filteredGroups.map((group) => (
                  <div key={group.vendor}>
                    <div className="px-4 py-1 text-xs font-semibold text-gray-400 bg-gray-900 sticky top-0 border-b border-gray-800">
                      {group.vendor}
                    </div>
                    {group.gpus.map((gpu) => (
                      <button
                        ...
                        className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-700 transition-colors ${selectedGpu?.name === gpu.name
